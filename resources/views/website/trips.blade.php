...
@section('title', __('dashboard.trips'))
@section('content')
                ...
                <div class="container">
                    <div class="row d-flex align-items-center justify-content-center">
                        <div class="col-md-6 main-header-col">
                            <h1 class="display-5 animated fadeIn mb-4 text-white"> {{ __('dashboard.trips') }}</h1>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="container">
                            <div class="row g-4">
                                <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s"
                                    style="max-width: 100%;">
                                    <h1 class="mb-1 section-title pb-2 lined-title">{{ __('dashboard.trips') }}</h1>
                                </div>
