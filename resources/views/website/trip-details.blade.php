                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="row col-md-6">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu input-dropdown dropdown-content">
                                                        <div class="px-3 py-2">
                                                            ...
                                                            <span class="text-danger" id="adults-error" style="font-size: x-small;"></span>
                                                            <div class="form-group row">
                                                                <div class="col-md-5 d-flex align-items-center">
                                                                    <label
                                                            ...
                                                            <span class="text-danger" id="children-error" style="font-size: x-small;"></span>
                                                            ...
                                                            <span class="text-danger" id="babies-error" style="font-size: x-small;"></span>
                                                            <div class="form-group row">
                                                                <div class="col-md-5 d-flex align-items-center">
                                                                    <label
                            ...
                            <div class="col-md-12 radio2 radio-section">
                                <form action="/search-hotels" method="POST" id="hotel-form">
                                    @csrf
                                    <div class="row">
                                        {{-- <div class="col-md-4">
                                                <div class="form-group">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu input-dropdown dropdown-content">
                                                        <div class="px-3 py-2">
                                                            ...
                                                            <span class="text-danger" id="hotel-adults-error" style="font-size: x-small;"></span>
                                                            <div class="form-group row">
                                                                <div class="col-md-5 d-flex align-items-center">
                                                                    <label
                                                                        for="travelrs">{{ __('dashboard.Children') }}</label>
                                                            ...
                                                            <span class="text-danger" id="hotel-children-error" style="font-size: x-small;"></span>
                                                            ...
                                                            <span class="text-danger" id="hotel-babies-error" style="font-size: x-small;"></span>
                                                            <div class="form-group row">
                                                                <div class="col-md-5 d-flex align-items-center">
                                                                    <label
                                                                        for="travelrs">{{ __('dashboard.Rooms') }}</label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).ready(function() {
                ...
                // Real-time validation for traveler inputs
                ...
                // Validate all traveler inputs on change
                // Plans form validation
                validateTravelerInput('adults', 6, '{{ __("dashboard.Maximum adults allowed is") }}');
                validateTravelerInput('children', 4, '{{ __("dashboard.Maximum children allowed is") }}');
                validateTravelerInput('babies', 4, '{{ __("dashboard.Maximum babies allowed is") }}');
                validateTravelerInput('rooms', 6, '{{ __("dashboard.Maximum rooms allowed is") }}');

                // Hotel form validation
                validateTravelerInput('hotel_adults', 6, '{{ __("dashboard.Maximum adults allowed is") }}');
                validateTravelerInput('hotel_children', 4, '{{ __("dashboard.Maximum children allowed is") }}');
                validateTravelerInput('hotel_babies', 4, '{{ __("dashboard.Maximum babies allowed is") }}');
                validateTravelerInput('hotel_rooms', 6, '{{ __("dashboard.Maximum rooms allowed is") }}');
                ...
                // Handle increment/decrement buttons with validation
                $('.increment-btn').on('click', function(e) {
                    e.preventDefault();
                    var input = $(this).siblings('input[type="number"]');
                    var currentValue = parseInt(input.val())-1 || 0;
                    var maxValue = parseInt(input.attr('max'));
                    var inputId = input.attr('id');
                    
                    if (currentValue < maxValue) {
                        input.val(currentValue + 1);
                        // Clear error message when successfully incrementing
                        if (inputId) {
                            var errorSpanId = inputId.replace('_', '-') + '-error';
                            $('#' + errorSpanId).html('');
                        }
                        ...
                        switch(fieldType) {
                            case 'adults':
                                message = '{{ __("dashboard.Maximum adults allowed is") }} ' + maxValue;
                                break;
                            case 'children':
                                message = '{{ __("dashboard.Maximum children allowed is") }} ' + maxValue;
                                break;
                            case 'infants':
                                message = '{{ __("dashboard.Maximum babies allowed is") }} ' + maxValue;
                                break;
                            case 'rooms':
                                message = '{{ __("dashboard.Maximum rooms allowed is") }} ' + maxValue;
                                break;
                        }
                        if (message && inputId) {
                            var errorSpanId = inputId.replace('_', '-') + '-error';
                            $('#' + errorSpanId).html(message);
                        }
                    }
                });
                ...
                $('.decrement-btn').on('click', function(e) {
                    ...
                    if (currentValue > minValue) {
                        input.val(currentValue - 1);
                        // Clear error message when successfully decrementing
                        if (inputId) {
                            var errorSpanId = inputId.replace('_', '-') + '-error';
                            $('#' + errorSpanId).html('');
                        }
