...
return [
    ...
    'main_slider_message_deleted' => '{ :user } Delete Main Slider  { :name }',
    'main_slider_title_updated' => ' Update Main Slider',
    ...
    'slider_message_deleted' => ' { :user } Delete Slider { :name }',
    'slider_title_updated' => ' Update Slider',
    ...
    'fixed_page_message_deleted' => ' { :user } Delete Fixed Page { :name }',
    'fixed_page_title_updated' => ' Update Fixed Page',
    ...
    'privilege_message_deleted' => ' { :user } Delete Privilege { :name }',
    'privilege_title_updated' => 'Update Privilege',
    ...
    'privilege_group_message_deleted' => ' { :user } Delete Privilege Group { :name }',
    'privilege_group_title_updated' => 'Update Privilege Group',
    ...
    'setting_message_deleted' => ' { :user } Delete Setting { :name }',
    'setting_title_updated' => ' Update Setting',
    ...
    'setting_type_message_deleted' => ' { :user } Delete Setting Type { :name }',
    'setting_type_title_updated' => 'Update Setting Type',
    'setting_type_message_updated' => ' { :user } Update Setting Type { :name }',
