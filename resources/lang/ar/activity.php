...
return [
    ...
    'main_slider_message_deleted' => ' قام { :user } حذف بنر رئيسي { :name } بنجاح ',
    'main_slider_title_updated' => ' تعديل بنر رئيسي',
    ...
    'slider_message_deleted' => 'قام { :user } حذف بنر  { :name } بنجاح',
    'slider_title_updated' => 'تعديل بنر',
    ...
    'fixed_page_message_deleted' => ' تم حذف صفحة ثابتة { :name } بنجاح',
    'fixed_page_title_updated' => ' تعديل صفحة ثابتة',
    ...
    'privilege_message_deleted' => ' قام { :user } حذف صلاحية { :name }  بنجاح',
    'privilege_title_updated' => ' تعديل صلاحية',
    ...
    'privilege_group_message_deleted' => ' قام { :user } حذف مجموعة صلاحيات  { :name } بنجاح',
    'privilege_group_title_updated' => ' تعديل مجموعة صلاحيات',
    ...
    'setting_message_deleted' => ' قام { :user } حذف اعداد { :name }  بنجاح',
    'setting_title_updated' => ' تعديل اعداد',
    ...
    'setting_type_message_deleted' => ' قام { :user } حذف نوع اعداد  { :name } بنجاح',
    'setting_type_title_updated' => ' تعديل نوع اعداد',
    'setting_type_message_updated' => ' قام { :user } تعديل نوع اعداد  { :name } بنجاح',
    ...
    'accept_withdrawal_request_title' => 'قبول طلب سحب رصيد',
    'accept_withdrawal_request_message' => 'الادارة قام بقبول الطلب رقم { :id } للعميل { :user } بقيمة { :amount }',

    'refuse_withdrawal_request_title' => 'رفض طلب سحب رصيد',
    'refuse_withdrawal_request_message' => 'الادارة قام برفض الطلب رقم { :id } للعميل { :user } بقيمة { :amount }',
